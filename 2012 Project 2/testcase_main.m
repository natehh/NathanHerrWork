...
%assumptions: flight only in x and z directions, the given equations can be used to
...
[t,y] = ode45('testcase_ODEFunc',tspan,[mAirI,mRocketI,Vairi,0,0,z0,0],Options);
%define ode returns
mAir = y(:,1);
mRocket = y(:,2);
Vair = y(:,3);
